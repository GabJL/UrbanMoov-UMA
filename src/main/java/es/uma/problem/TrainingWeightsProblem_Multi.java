...
public class TrainingWeightsProblem_Multi extends TrainingWeightsProblem {
    public TrainingWeightsProblem_Multi(AlgorithmConfiguration algorithmConfiguration) {
        super(algorithmConfiguration);
        setNumberOfVariables(getNet().getNumberOfParameters());
        setNumberOfObjectives(2);
        setName("TrainingWeightsProblemMultiobjective");
